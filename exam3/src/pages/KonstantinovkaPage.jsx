...
import { Box, Typography, Container, useTheme, useMediaQuery, Grid, Paper, Button, IconButton } from '@mui/material';
...
// Image imports
import bgImage from '../assets/a12ddf13978a5743c80b828dffe469e075e1ca69.jpg';
import aboutImg from '../assets/454aba1b0c4c7a706d37f20cdabc6d8e7f5ddb80 (1).jpg';
import galleryImg from '../assets/d4a4cffbf55a06577e9eaa51a0e09dd0de92d345.jpg';
import videoImg from '../assets/73c6903a897f4616610e5212a7d9d2e96e2eb4c9.jpg';
import ctaBg from '../assets/3142198591aa88e2d75476d14bcf0111897e675e.jpg';
import projectImg1 from '../assets/6c50ee169f27a03575d71b9637769b7833a4bb27 (1).jpg';
import projectImg2 from '../assets/c6c33d5498b4277a1f97a6f09a7d458b9ca4f259.jpg';

export default function KonstantinovkaPage() {
    ...
    <Box>
      ...
      >
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2, color: 'white' }}>
          ...
          <Typography variant="h1" sx={{ fontWeight: 800, fontSize: { xs: '3rem', sm: '4.5rem', md: '7rem' }, color: '#eca668', textTransform: 'uppercase', lineHeight: 1, letterSpacing: '-1px' }}>
            КОНСТАНТИНОВКА
          </Typography>
        </Container>
      </Box>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 8, md: 12 }, mb: 8 }}>
        ...
        {isMobile && (
           <Typography sx={{ fontSize: '1.2rem', mb: 5, lineHeight: 1.6, fontWeight: 500 }}>
             Константиновка - это проектное строительство частных домов на территории поселка Константиновка (г. Казань)
           </Typography>
        )}
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 8 }, mb: 4, overflow: 'hidden' }}>
        ...
        <Box sx={{ 
          ...
          {[1, 2, 3].map((item) => (
            ...
            >
              <Box component="img" src={galleryImg} sx={{ width: '100%', height: { xs: 400, md: 600 }, objectFit: 'cover' }} />
              <Paper sx={{ 
                position: 'absolute', 
                bottom: { xs: 15, md: 30 }, 
                left: { xs: 15, md: 30 }, 
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 8 }, mb: 4 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', mb: { xs: 4, md: 6 } }}>
          <Typography variant="h3" sx={{ fontWeight: 700, textTransform: 'uppercase', fontSize: { xs: '1.8rem', md: '2.5rem' }, whiteSpace: 'nowrap' }}>
            <span style={{ color: '#eca668', fontWeight: 400, fontStyle: 'italic' }}>ВИДЕО</span> О ПРОЕКТЕ
          </Typography>
          <Box sx={{ flexGrow: 1, display: 'flex', alignItems: 'flex-start', height: { xs: 20, md: 40 }, mt: { xs: 1, md: 2 }, ml: { xs: 2, md: 4 } }}>
        ...
        <Box sx={{ position: 'relative', width: '100%', cursor: 'pointer', '&:hover .play-icon': { transform: 'translate(-50%, -50%) scale(1.1)', color: '#eca668' } }}>
          <Box component="img" src={videoImg} sx={{ width: '100%', height: { xs: 300, md: 600 }, objectFit: 'cover' }} />
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 8 }, mb: 4 }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: { xs: 4, md: 6 } }}>
          <Box sx={{ width: { xs: '100%', md: '50%' }, maxWidth: { md: 520 } }}>
            <Box component="img" src={projectImg2} sx={{ width: '100%', height: { xs: 240, md: 280 }, objectFit: 'cover', mb: 3 }} />
          ...
          <Box sx={{ width: { xs: '100%', md: '50%' }, maxWidth: { md: 520 } }}>
            <Box component="img" src={projectImg1} sx={{ width: '100%', height: { xs: 240, md: 280 }, objectFit: 'cover', mb: 3 }} />
            <Typography sx={{ fontWeight: 700, fontSize: '1.3rem', mb: 1, textTransform: 'uppercase' }}>
              IQ CLUB
            </Typography>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
