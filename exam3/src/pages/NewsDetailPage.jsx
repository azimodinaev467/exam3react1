            ...
            <Box sx={{ flex: 1, maxWidth: { lg: '75%' } }}>
              ...
              <Box
                ...
                sx={{
                  ...
                  '&:hover': { borderBottom: '1px solid #E89A55' }
                }}
              >
                Читать далее →
              </Box>
              ...
              <Box sx={{ mt: 6, pt: 4, borderTop: '1px solid #eee' }}>
                <Typography sx={{ fontSize: '14px', fontWeight: 600, color: '#111', textTransform: 'uppercase', letterSpacing: '0.05em', mb: 2 }}>
                  Поделиться
                </Typography>
            ...
            <Box sx={{ width: { xs: '100%', lg: '320px' }, flexShrink: 0 }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                {otherNews.map((news) => (
                  <Box
                    key={news.id}
                    onClick={() => navigate(`/about/news/${news.id}`)}
                    sx={{
