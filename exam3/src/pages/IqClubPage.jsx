...
import bgImage from '../assets/6c50ee169f27a03575d71b9637769b7833a4bb27 (1).jpg';
...
import planImage from '../assets/353f068a809180ebda01ee4d9d982bb6ebcd9241.png';
import galleryImage from '../assets/c6c33d5498b4277a1f97a6f09a7d458b9ca4f259.jpg';

export default function IqClubPage() {
  const theme = useTheme();
  const isMobile = useMediaQuery(theme.breakpoints.down('md'));
  const [activeMarker, setActiveMarker] = useState(null);

  const features = [
    { icon: iconSchool, text: 'Комфорт закрытого клуба внутри города' },
    { icon: iconBus, text: 'Просторная квадратура для жизни большой семьи' },
    { icon: iconMall, text: 'Развитая инфраструктура вокруг' },
    { icon: iconMap, text: 'Закрытая территория с пропускной системой безопасности' },
  ];

  const mapMarkers = [
    { id: 1, top: '69%', left: '62%', title: 'Выезд 1' },
    ...
    <Box>
      ...
      >
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2, color: 'white' }}>
          <Typography variant="h6" sx={{ fontWeight: 400, mb: 1, fontSize: { xs: '1rem', md: '1.2rem' } }}>
            Таунхаус-клуб комфорт-класса в Казани
          </Typography>
          <Box sx={{ display: 'flex', alignItems: 'baseline', flexWrap: 'wrap', gap: { xs: 1, md: 2 } }}>
             <Typography variant="h1" sx={{ fontWeight: 700, fontSize: { xs: '3.5rem', md: '6rem' }, color: '#df924e', textTransform: 'uppercase', lineHeight: 1 }}>
                IQ
             </Typography>
             <Typography variant="h1" sx={{ fontWeight: 700, fontSize: { xs: '3.5rem', md: '6rem' }, color: 'white', textTransform: 'uppercase', lineHeight: 1 }}>
                CLUB
             </Typography>
          </Box>
        </Container>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 8, md: 12 } }}>
        ...
        {isMobile && (
           <Typography sx={{ fontSize: '1.1rem', mb: 5, lineHeight: 1.6 }}>
             <span style={{ color: '#df924e', fontWeight: 600 }}>Таунхаус-клуб IQ CLUB</span> - это инновационный жилой комплекс, где все жилые здания представляют собой комфортные таунхаусы. IQClub предлагает жителям уникальную комбинацию преимуществ жилья в частном секторе и удобств общего пользования, таких как парк, детские площадки, зона для барбекю и спортивные площадки.
           </Typography>
        )}
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 8 }, mb: 4 }}>
        ...
        <Grid container spacing={4} sx={{ mb: { xs: 6, md: 8 } }}>
          <Grid item xs={12} md={6}>
            <Typography sx={{ fontSize: '1.05rem', lineHeight: 1.6 }}>
              Строительство таунхаус-клуба ведется на пересечении улиц Сабантуй, Милой и Мира. В непосредственной близости к торговым центрам Мега, Южный и Франт. На территории крупнейшего, активно развивающегося района города Казани - Приволжский.
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
            <Typography sx={{ fontSize: '1.05rem', lineHeight: 1.6 }}>
              Хорошая транспортная и пешеходная доступность, социальная и инженерная инфраструктура: детские сады, школы, административные учреждения. Рядом с клубом есть все для комфортной жизни.
            </Typography>
          </Grid>
        </Grid>
        ...
        <Box sx={{ position: 'relative', width: '100%', height: { xs: 400, md: 600 }, mb: 4 }}>
          <iframe 
            src="https://yandex.ru/map-widget/v1/?ll=49.202348%2C55.760131&z=12" 
            width="100%" 
            height="100%" 
            frameBorder="0" 
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 8 }, mb: 4, overflow: 'hidden' }}>
        <Box sx={{ mb: { xs: 4, md: 6 }, display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: { xs: 'flex-start', md: 'center' }, gap: { xs: 0, md: 1 } }}>
           <Typography variant="h3" sx={{ fontWeight: 700, textTransform: 'uppercase', fontSize: { xs: '2rem', md: '2.5rem' } }}>
              ГАЛЕРЕЯ
           </Typography>
        </Box>
          ...
          {[1, 2, 3].map((item, index) => (
            ...
            >
              ...
              <Paper sx={{ 
                ...
                <Typography sx={{ fontWeight: 700, mb: 1, fontSize: '1.1rem' }}>Таунхаус, вид снаружи</Typography>
                <Typography sx={{ fontSize: '0.95rem' }}>Визуализация</Typography>
              </Paper>
            </Box>
          ))}
        </Box>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 8 }, mb: 4 }}>
        <Typography variant="h3" sx={{ fontWeight: 700, mb: 6, textTransform: 'uppercase', fontSize: { xs: '1.8rem', md: '2.5rem' } }}>
          ДРУГИЕ <span style={{ color: '#E87A1E', fontWeight: 300 }}>ПРОЕКТЫ</span>
        </Typography>
        ...
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: { xs: 4, md: 6 } }}>
          <Box sx={{ width: { xs: '100%', md: '50%' }, maxWidth: { md: 520 } }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <LocationOnOutlinedIcon sx={{ color: '#E87A1E', fontSize: 20 }} />
              <Typography sx={{ fontSize: '0.95rem' }}>
                8 минут от метро Дубравная. <span style={{ color: '#E87A1E' }}>Дома сдаются</span>
              </Typography>
            </Box>
          </Box>
          
          <Box sx={{ width: { xs: '100%', md: '50%' }, maxWidth: { md: 520 } }}>
            <Box component="img" src={galleryImage} sx={{ width: '100%', height: { xs: 240, md: 280 }, objectFit: 'cover', mb: 3 }} />
            <Typography sx={{ fontWeight: 700, fontSize: '1.3rem', mb: 1, textTransform: 'uppercase' }}>
              ДОМА В ЗИМНЕЙ ГОРКЕ
            </Typography>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <LocationOnOutlinedIcon sx={{ color: '#E87A1E', fontSize: 20 }} />
              <Typography sx={{ fontSize: '0.95rem' }}>
                10 минут от Казанского аэропорта. <span style={{ color: '#E87A1E' }}>Все дома сданы</span>
              </Typography>
            </Box>
          </Box>
        </Box>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 8 }, mb: 8 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 2, md: 4 }, mb: { xs: 4, md: 6 } }}>
          <Typography variant="h3" sx={{ fontWeight: 700, textTransform: 'uppercase', fontSize: { xs: '1.8rem', md: '2.5rem' }, whiteSpace: 'nowrap' }}>
            <span style={{ color: '#E87A1E', fontWeight: 400, fontStyle: 'italic' }}>ОФИС</span> ПРОДАЖ
          </Typography>
