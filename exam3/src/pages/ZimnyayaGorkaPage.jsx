...
import { Box, Typography, Container, useTheme, useMediaQuery, Grid, Paper, Button } from '@mui/material';
...
import bgImage from '../assets/e8961916c9fca913dd94d2de13a562dc82b208c6.jpg';
import img1 from '../assets/e8961916c9fca913dd94d2de13a562dc82b208c6.jpg';
import img2 from '../assets/e8961916c9fca913dd94d2de13a562dc82b208c6.jpg';
...
export default function ZimnyayaGorkaPage() {
    ...
    <Box>
      ...
      >
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2, color: 'white' }}>
          ...
          <Typography variant="h1" sx={{ fontWeight: 800, fontSize: { xs: '4.5rem', md: '8rem' }, color: 'white', textTransform: 'uppercase', lineHeight: 1, letterSpacing: '-1px' }}>
            <span style={{ color: '#eca668' }}>ЗИМНЯЯ</span> ГОРКА
          </Typography>
        </Container>
      </Box>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 8, md: 12 }, mb: 8 }}>
        ...
        {isMobile && (
           <Typography sx={{ fontSize: '1.2rem', mb: 5, lineHeight: 1.6, fontWeight: 500 }}>
             Зимняя Горка - это проектное строительство частных домов на территории поселка Зимняя Горка (г. Казань)
           </Typography>
        )}
      ...
      <Box sx={{ 
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2, color: 'white', textAlign: 'center' }}>
          <Typography variant="h2" sx={{ fontWeight: 700, fontSize: { xs: '1.4rem', md: '2.2rem' }, mb: 1, textTransform: 'uppercase', lineHeight: 1.3 }}>
            ...
            КОТТЕДЖНОМ ПОСЕЛКЕ <span style={{ color: '#eca668' }}>ЗИМНЯЯ ГОРКА</span>
          </Typography>
